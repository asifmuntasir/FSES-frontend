...
export default function UTMLoginPage() {
  ...
  return (
    ...
    <div className="w-full min-h-screen back-gr flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="p-6 flex flex-col items-center">
          ...
          <div className="text-center mt-2">
            <h2 className="text-burgundy-700 text-lg">First Step Evaluation System</h2>
          </div>
        </div>
        ...
        <div className="px-6 pb-6">
          <div className="mb-4">
            <input
              ...
              className="w-full px-3 py-3 bg-yellow-50 border border-yellow-100 rounded focus:outline-none"
            />
          </div>
          <div className="mb-6">
            <input
          ...
          <div className="mt-4 text-center">
            <a className="text-burgundy-700 text-sm hover:underline cursor-pointer">Lost password?</a>
          </div>
